...
;(function(window, undefined) {
  ...
  // use `setImmediate` if it's available in Node.src
   ...
   * fs.writeFileSync(path.join(cwd, 'jst.src'), '\
   *   var JST = {\
  ...
  // expose Lo-Dash
  // some AMD build optimizers, like r.src, check for specific condition patterns like the following:
