...
test('#62: deep module references and the pathFilter', function(t){
	...
	resolve('deep/ref', { basedir : resolverDir }, function (err, res, pkg) {
        ...
        t.equal(pkg.version, "1.2.3");
        t.equal(res, resolverDir + '/node_modules/deep/ref.src');
    });
    ...
    function(err, res, pkg) {
      ...
      t.equal(pkg.version, "1.2.3");
      t.equal(res, resolverDir + '/node_modules/deep/deeper/ref.src');
    });
    
    resolve('deep/ref', { basedir : resolverDir, pathFilter : pathFilter },
    function (err, res, pkg) {
        if (err) t.fail(err);
        t.equal(res, resolverDir + '/node_modules/deep/alt.src');
    });
});
