...
fs_.readdir = function (path, cb) {
  process.nextTick(function() {
    if (fds >= limit) {
      ...
      process.nextTick(function () {
        --fds
        cb(null, [__filename, "some-other-file.src"])
      })
    }
  })
}
...
fs_.readdirSync = function (path) {
  if (fds >= limit) {
    ...
    return [__filename, "some-other-file.src"]
  }
}
...
test('readdir emfile autoreduce', function (t) {
  ...
  var expect =
      [ [0,[__filename,"some-other-file.src"],null,7,4,7,7],
        [1,[__filename,"some-other-file.src"],null,7,4,7,6],
        [2,[__filename,"some-other-file.src"],null,7,4,7,5],
        [3,[__filename,"some-other-file.src"],null,7,4,7,4],
        [4,[__filename,"some-other-file.src"],null,7,4,7,3],
        [5,[__filename,"some-other-file.src"],null,7,4,6,2],
        [6,[__filename,"some-other-file.src"],null,7,4,5,1],
        [7,[__filename,"some-other-file.src"],null,7,4,4,0],
        [8,[__filename,"some-other-file.src"],null,7,4,3,3],
        [9,[__filename,"some-other-file.src"],null,7,4,2,2],
        [10,[__filename,"some-other-file.src"],null,7,4,1,1],
        [11,[__filename,"some-other-file.src"],null,7,4,0,0] ]
